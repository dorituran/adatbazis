...
```js
set ev 2021 ex 10// set kulcs ertek ex lejárat ideje
set honap ex 10
set nap 26 ex 10
```
...
```js
hset auto rendszam xxx-111 tipus "Skoda Fabia" evjarat 2012 ertek 1500000 //hset hash kulcsot hoz létre ez egy sornak felel meg egy táblából
```
...
```js
rpush tantargyak "programozas alapjai" matematika adatbaziskezeles //az idézőjel a szóközös rekord miatt kell, rpush a lista létrehozása és feltöltése
...
```js
sadd numbers1 10 20 30 40 50 60 //sadd halmazt hoz létre
sadd numbers2 15 30 45 60
SINTER numbers1 numbers2 //SINTER halmaz művelet metszet
```
